...
Mobile.takeScreenshot("${screenshotPath}\\ScreenOfDAY1_afterSwipe.png")

'Get displayed message on the dialog'
def message = Mobile.getText(findTestObject('Schedule/txtSwipeFor_At_Day1'),	GlobalVariable.G_LongTimeOut)
