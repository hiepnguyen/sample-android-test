...
WebUI.callTestCase(findTestCase('General/Mobile manipulator/Swipe/Schedule/swipeRightForDay1_at_Day2'), [:], FailureHandling.CONTINUE_ON_FAILURE)

'Swipe on the screen to horizontal swipe left'
WebUI.callTestCase(findTestCase('General/Mobile manipulator/Swipe/Schedule/swipeLeftForDay2_at_Day1'), [:], FailureHandling.CONTINUE_ON_FAILURE)
